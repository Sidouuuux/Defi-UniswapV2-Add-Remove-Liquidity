...
import "../src/UniswapV2AddRemoveLiquidity.sol";

IERC20 constant WETH = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
IERC20 constant USDT = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
IERC20 constant PAIR = IERC20(0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852);

contract UniswapV2AddRemoveLiquidityTest is Test {
    UniswapV2AddRemoveLiquidity private uni = new UniswapV2AddRemoveLiquidity();
    ...
    function testRemoveLiquidity() public {
        // Deal LP tokens to uni so we can be able to remove liquidity
        ...
        uni.removeLiquidity(address(WETH), address(USDT));
                console.log('balanceOf: ', USDT.balanceOf(address(uni)));
